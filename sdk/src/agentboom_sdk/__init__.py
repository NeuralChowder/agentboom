...
agentboom_sdk.voice       assistant identity: deterministic sign-offs that
                          never sign as the principal
agentboom_sdk.activity    a human-readable activity feed (never raises)
