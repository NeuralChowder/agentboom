"""`agentloom list|skills|miniapps` — discovery commands (JSON-friendly)."""
import json
from pathlib import Path

from agentloom.checks import parse_frontmatter
from agentloom.registry import load_registry


def run_list(args) -> dict:
    """Discover agentloom agents one level below a parent directory."""
