-- Self-evolve (agentboom package: self-evolve).
-- The loop's memory and control surface: runs, backlog, repair requests,
-- the fitness landscape, friction, change outcomes and guardrail alerts.
-- Timestamps are ISO-8601 UTC strings written by the app (portable);
-- JSON in TEXT; flat table names; no schema prefixes.
