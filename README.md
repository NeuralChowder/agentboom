...
pipx install "agentboom @ https://github.com/agent-boom/agentboom-sdk/releases/download/v0.7.0/agentboom-0.7.0-py3-none-any.whl"
```

**No `pipx`? Plain `pip` works too:**

```bash
pip install "agentboom @ https://github.com/agent-boom/agentboom-sdk/releases/download/v0.7.0/agentboom-0.7.0-py3-none-any.whl"
```
